...
export function UsageWarningBanner({
  ...
  const config = {
    info: {
      ...
      bgClass: 'bg-mirror-info/10 border-mirror-info/30',
      iconClass: 'text-mirror-info',
      progressClass: 'bg-mirror-info',
    },
    warning: {
      color: 'yellow',
      icon: AlertTriangle,
      title: 'Almost at Your Limit',
      bgClass: 'bg-mirror-warning/10 border-mirror-warning/30',
      iconClass: 'text-mirror-warning',
      progressClass: 'bg-mirror-warning',
    },
    error: {
      color: 'red',
      icon: Ban,
      title: 'Reflection Limit Reached',
      bgClass: 'bg-mirror-error/10 border-mirror-error/30',
      iconClass: 'text-mirror-error',
      progressClass: 'bg-mirror-error',
    },
  };

...
// Provides reusable user factories for testing with override pattern
 ...
 * @example
 * ```typescript
 * const userRow = createMockUserRow({ tier: 'pro' });
 * ```
 */
 ...
 *
 * @param tier - Subscription tier (free, pro, unlimited)
 * @param status - Subscription status (defaults to 'active')
 * @returns User object with specified tier and status
 *
 * @example
 * ```typescript
 * const proUser = createUserWithTier('pro');
 * const canceledProUser = createUserWithTier('pro', 'canceled');
 * ```
 */
 ...
 *
 * @param monthlyCount - Number of reflections this month
 * @param dailyCount - Number of reflections today (defaults to 0)
 * @param totalCount - Total reflections (defaults to monthlyCount)
 * @returns User object with specified reflection counts
 *
 * @example
 * ```typescript
 * const userAtLimit = createUserWithReflections(2, 1);
 * ```
 */
 ...
 * @returns User object with specified language
 *
 * @example
 * ```typescript
 * const heUser = createUserWithLanguage('he');
 * ```
 */
 ...
 * @returns Array of User objects with unique IDs and emails
 *
 * @example
 * ```typescript

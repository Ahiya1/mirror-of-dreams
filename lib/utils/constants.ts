...
export const REFLECTION_MICRO_COPY = {
  ...
  questionProgress: (current: number, total: number) =>
    `Question ${current} of ${total} — You're doing great`,
  ...
  reflectionComplete:
    'Your reflection is complete. If you would like to add more, consider starting a new reflection.',
} as const;
...
export const TONE_DESCRIPTIONS = {
  fusion:
    'Balanced wisdom where all voices become one. Expect both comfort and challenge, woven together in sacred harmony.',
  gentle:
    'Soft wisdom that illuminates gently. Your mirror will speak with compassion, holding space for vulnerability.',
  intense:
    'Piercing truth that burns away illusions. Expect direct clarity that honors your readiness for transformation.',
} as const;

// src/components/portal/components/MainContent.jsx - Central portal content
 ...
 * @param {Object} props.taglines - Taglines configuration
 * @param {Object} props.usageConfig - Usage display configuration
        ...
        {!isAuthenticated && (
          <div className="sign-in-prompt">
            <p className="prompt-text">
              ...
              <a href="/auth/signin" className="sign-in-link">
                Sign in
              </a>
            </p>
          </div>

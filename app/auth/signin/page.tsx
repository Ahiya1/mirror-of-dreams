 ...
 * Migrated from src/components/auth/SigninForm.jsx
 */
      ...
      <div className="w-full max-w-md">
        ...
        <div className="backdrop-blur-md bg-white/5 border border-white/10 rounded-2xl p-8 shadow-2xl">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-white/60">Continue your journey of self-discovery</p>
          </div>
          ...
          <div className="signin-footer">
            <p className="signup-text">New to Mirror of Dreams?</p>
            <button
              type="button"

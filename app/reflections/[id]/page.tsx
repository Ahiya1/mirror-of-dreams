        ...
        <div className="max-w-4xl mx-auto">
          <div className="flex items-center justify-center min-h-[400px]">
            <div className="text-center space-y-4">
              ...
              <p className="text-white/70 text-lg">Retrieving your reflection...</p>
            </div>
          </div>
        </div>
      </div>
          ...
          {showFeedbackForm ? (
            ...
            !reflection.rating && (
              <button
                ...
                className="w-full rounded-xl border border-purple-500/20 bg-white/5 px-4 py-4 text-white/80 hover:bg-white/10 hover:border-amber-400/30 transition-all flex items-center justify-center gap-2"
              >

      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <div className="flex items-start justify-between gap-4">
            {isEditing ? (
              <div className="flex-1">
                <input
                  ...
                  className="w-full rounded-lg border border-purple-500/20 bg-slate-900/50 px-4 py-3 text-2xl font-bold text-white placeholder-gray-400 backdrop-blur-sm transition-all focus:border-purple-500/50 focus:outline-none focus:ring-2 focus:ring-purple-500/20"
                />
                <div className="flex gap-2 mt-3">
                  ...
                  <button
                    ...
                    className="rounded-lg border border-gray-600 px-4 py-2 text-sm font-medium text-gray-300 hover:bg-slate-800 transition-colors"
                  >
                    Cancel
                  </button>
                </div>
            ...
            {reflection.isPremium && (
              <span className="inline-flex items-center gap-1 rounded-full bg-gradient-to-r from-amber-500/20 to-yellow-500/20 border border-amber-500/30 px-3 py-1 text-sm font-medium text-amber-300">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            {/* AI Response */}
            <div className="rounded-xl border border-purple-500/20 bg-gradient-to-br from-slate-900/90 to-slate-800/90 p-6 backdrop-blur-sm">
            ...
            <div className="rounded-xl border border-purple-500/20 bg-gradient-to-br from-slate-900/90 to-slate-800/90 p-6 backdrop-blur-sm">
              ...
              <div className="space-y-4 text-sm">
                <div>
                  <h3 className="font-semibold text-gray-300 mb-2">Dream</h3>
                  <p className="text-gray-400">{reflection.dream}</p>
                </div>
                <div>
                  <h3 className="font-semibold text-gray-300 mb-2">Plan</h3>
                  <p className="text-gray-400">{reflection.plan}</p>
                </div>
                {reflection.dreamDate && (
                  <div>
                    <h3 className="font-semibold text-gray-300 mb-2">Date</h3>
                    <p className="text-gray-400">{reflection.dreamDate}</p>
                  </div>
                )}
                <div>
                  <h3 className="font-semibold text-gray-300 mb-2">Relationship</h3>
                  <p className="text-gray-400">{reflection.relationship}</p>
                </div>
                <div>
                  <h3 className="font-semibold text-gray-300 mb-2">Offering</h3>
                  <p className="text-gray-400">{reflection.offering}</p>
                </div>
              </div>
            </div>
          ...
          <div className="space-y-6">
            ...
            <div className="rounded-xl border border-purple-500/20 bg-gradient-to-br from-slate-900/90 to-slate-800/90 p-6 backdrop-blur-sm">
              ...
              {reflection.userFeedback && (
                <div className="mt-4 pt-4 border-t border-purple-500/20">
                  <h4 className="text-sm font-semibold text-gray-300 mb-2">Your Feedback</h4>
                  <p className="text-xs text-gray-400 italic">&ldquo;{reflection.userFeedback}&rdquo;</p>
                  <button
                    onClick={() => setShowFeedbackForm(true)}
            ...
            <div className="rounded-xl border border-purple-500/20 bg-gradient-to-br from-slate-900/90 to-slate-800/90 p-6 backdrop-blur-sm">
              ...
              <div className="space-y-3">
                ...
                <button
                  disabled
                  className="w-full flex items-center justify-center gap-2 rounded-lg bg-slate-800/30 px-4 py-2.5 text-sm font-medium text-gray-500 cursor-not-allowed"
                  title="Coming soon"
                >
                  <svg className="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
